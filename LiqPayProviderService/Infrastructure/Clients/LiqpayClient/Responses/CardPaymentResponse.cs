...
namespace LiqPayProviderService.Infrastructure.Clients.LiqpayClient.Responses;
...
public class CardPaymentResponse
{
    ...
    [JsonConverter(typeof(StringEnumConverter))]
    public MpiEci MpiEci { get; set; }
    [JsonProperty("mpi_cres")]
    public string? MpiCres { get; set; }
